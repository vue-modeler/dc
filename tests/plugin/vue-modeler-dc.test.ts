...
vi.mock('../../src/container/descriptor-container', () => ({
  DescriptorContainer: vi.fn().mockImplementation(function() {
    return Object.create(DescriptorContainer.prototype) as DescriptorContainer
  })
}))
...
describe('vueModelerDc', () => {
  ...
  it('should initialize $vueModelerDc only after create Vue application instance', () => {
    ...
    expect(DescriptorContainer).toHaveBeenCalledTimes(1)
    expect(appInstance.$vueModelerDc).toBeDefined()
    expect(appInstance.$vueModelerDc).toBeInstanceOf(DescriptorContainer)
  })
  ...
  it('should define $vueModelerDc property on the component', () => {
    ...
    expect(wrapper.vm.$vueModelerDc).toBeInstanceOf(DescriptorContainer)
  })
  ...
  it('should create unique DescriptorsContainer instances for different localVue instances', () => {
    ...
    expect(DescriptorContainer).toHaveBeenCalledTimes(2)
  })
